  ...
  <div>
      ...
      <el-row>
        ...
        <el-col :span="3">
          <div class="tubiao-contianer">
            ...
            <div class="title">
              <user-popover v-if="loginFlag===true"  ></user-popover>
              <div v-else>
    ...
    <el-dialog  :visible.sync="showDialog" width="30%" custom-class="loginUp-dialog">
      <el-form  :model="loginForm"  class="loginUp" auto-complete="on" label-position="left">
        ...
        <el-form-item >
          <template>
            <el-checkbox-group v-model="rememberName" >
              <el-checkbox  label="1">记住用户名</el-checkbox>
            </el-checkbox-group>
...
export default {
  ...
  methods: {
    ...
    showLogin: function () {
      ...
      if(localStorage.getItem("REM_NAME")==true){//如果未记录用户名则清空缓存
        console.log("统统清空")
      ...
      if(localStorage.getItem("AUTO_LOGIN").trim() == 'true'.trim()){
        this.login()
      }else{
        // this.loginFlag = '是'
